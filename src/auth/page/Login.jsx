...
const Login = () => {
    ...
    const {login} = useContext(UserContext); // Para el contexto de usuario
    const {email, password, onInputChange} = useForm(initialForm); // Para manejar el formulario
    ...
    const [isPasswordVisible, setIsPasswordVisible] = useState(false); // Para el campo "Contraseña"
    const [isConfirmPasswordVisible, setIsConfirmPasswordVisible] = useState(false); // Para el campo "Repetir Contraseña"
    const [confirmPassword, setConfirmPassword] = useState(""); // Almacena la confirmación de la contraseña
    const [passwordsMatch, setPasswordsMatch] = useState(true); // Verifica si las contraseñas coinciden
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className={`${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'} p-6 rounded-lg shadow-lg w-80 transition-colors duration-300`}>
                        ...
                        >
                            ...
                            <div className="mb-4">
                                <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Apellidos</label>
                                <input
                                    name="apellidos"
                                    type="text"
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 ${
                            ...
                            <div className="mb-4">
                                <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Repetir Contraseña</label>
                                <div className="relative">
                                    <input
                        ...
                        <div className="mt-4 space-y-2">
                            <button
                                className="w-full flex items-center justify-center bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition"
                            >
                                <i className="bi bi-facebook mr-2"></i> Registrarse con Facebook
                            </button>
                            <button
                                className="w-full flex items-center justify-center bg-red-500 text-white py-2 rounded-lg hover:bg-red-600 transition"
                            >
                                <i className="bi bi-google mr-2"></i> Registrarse con Google
                            </button>
                            <button
                                className="w-full flex items-center justify-center bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 transition"
                            >
                                <i className="bi bi-spotify mr-2"></i> Registrarse con Spotify
                            </button>
                        </div>
                        <button
                            onClick={toggleRegister}
